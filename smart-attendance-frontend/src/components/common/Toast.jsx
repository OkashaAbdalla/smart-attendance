 ...
 * Used by ToastContext to display notifications
 */
...
const Toast = ({ message, type = 'info', onClose }) => {
  ...
  return (
    <div className={`flex items-center p-4 border-l-4 rounded-lg shadow-lg max-w-sm w-full animate-slide-in ${styles[type]}`}>
      ...
      <button
        onClick={onClose}
        className="ml-4 flex-shrink-0 inline-flex text-current hover:opacity-75 transition"
      >
